...
unsigned char* SZ_fast_compress_args_unpredictable_float_pwr(float *data, size_t *outSize, float absErrBound, size_t r5, size_t r4, size_t r3, size_t r2, size_t r1, float pwrBoundRatio)
{
	//TODO
}
