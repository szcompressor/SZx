...
#define SZ_GOOD_SPEED 0
#define SZ_BEST_SPEED 1
#define SZ_BEST_SPEED2 2
#define SZ_BEST_COMPRESSION 3
#define SZ_DEFAULT_COMPRESSION 4
#define SZ_TEMPORAL_COMPRESSION 5
